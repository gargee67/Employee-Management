...
function calculatesalary(){
    ...
    const total=(changeh*hr1)+(overt*ocharge);
    //console.log(total);
            ...
            <span class="close" onClick={()=>onClose()}>&times;</span>
                <div className="count">
                   ...
                   <h1>Salary Calculate</h1>
                    ...
                    <h3>{department}</h3> <br/>
                    <label for="entry-date 1" className="t">Charge Per Hour:</label>
                    ...
                    <label for="entry-date 1" className="t">Over Time:</label>
                    <input type="text" id="overtime" name="overtime" onChange={eve} value={startvalue.overtime}/><br/>
                    <label for="entry-date 1" className="t">Charge Per OverTime Hour:</label>
